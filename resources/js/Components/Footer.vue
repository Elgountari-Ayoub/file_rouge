...
<template>
    <footer class="relative bottom-0 bg-white -z-10" aria-labelledby="footer-heading">
      <!-- <h2 id="footer-heading" class="sr-only">Footer</h2> -->
      <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            <span class="h-10 text-2xl">You Coach</span>
            <p class="text-base text-gray-500">Empowering you to become your best self through personalized fitness coaching.</p>
