                        ...
                        <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-1">
                                    ...
                                    <input v-model="form.specialization" type="text" id="specialization"
                                ...
                                <div class="col-span-6 sm:col-span-1">
                                    ...
                                    <input v-model="form.country" type="text" id="country" name="country"
                                ...
                                <div class="col-span-6 sm:col-span-1">
                                    ...
                                    <input v-model="form.phone" type="number" id="phone" name="phone" autocomplete="phone"
                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <textarea v-model="form.experience" id="experience" name="experience" rows="3"
